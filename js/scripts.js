$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Paul and Anita's Wedding",

            // Event start date
            start: new Date('Sep 14, 2024 12:00'),
            ...
            end: new Date('Sep 15, 2024 00:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'd390d3da2959fcf07b08b99257b0f310'
            && MD5($('#invite_code').val()) !== 'd390d3da2959fcf07b08b99257b0f310') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbziLjX10Eyv-GbKwOMcWlIVrgV96SRwbiT6sa2XgXs62cl4heuWyH4-fBh-q3fkvnWT/exec', data)
                .done(function (data) {
                    console.log(data);
